    ...
    entry_points={
        "console_scripts": [
            "publisher_forward_position_controller = \
                venus_test_nodes.publisher_forward_position_controller:main",
            # "publisher_joint_trajectory_controller = \
            #     venus_control_test_nodes.publisher_joint_trajectory_controller:main",
        ],
    },
)
